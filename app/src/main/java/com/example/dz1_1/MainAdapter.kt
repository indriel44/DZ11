...
class MainAdapter(private val list: List<String>, val callback: (Int) -> Unit) : RecyclerView.Adapter<MainAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View, val callback: (Int) -> Unit) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(square: String) {
            ...
            val SquareButton = number
            SquareButton.setOnClickListener { callback(i) }
        }
    }
}
